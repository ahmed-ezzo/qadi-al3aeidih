document.addEventListener("DOMContentLoaded", () => {
  ...
  const SCENARIOS = [
    ...
    {
      crime: "تم العثور على بصمات أصابع مليئة بالطحين على خزنة البنك.",
      suspect_roles: [
        "خبَّاز 🥖",
        "طباخ 👨‍🍳",
        "حلواني 🍰",
      ...
      clues: [
        "شوهد شخص يشتري كميات كبيرة من الخميرة.",
        "مفتاح الخزنة تم نسخه باستخدام قالب من العجين.",
        "تم العثور على بقايا خبز محترق قرب المكان."
      ]
    },
    {
      crime: "تمت سرقة لوحة فنية شهيرة، وتُركت ريشة غريبة في المكان.",
      suspect_roles: [
        "رسَّام 🎨",
        "مؤرخ فني 🧐",
        "صاحب معرض 🖼️",
      ...
      clues: [
        "الريشة المستخدمة نادرة لا يستعملها إلا المحترفون.",
        "عُطل الليزر باستخدام مجموعة من المرايا الصغيرة.",
        "الفاعل لديه حساسية من زيت التربنتين."
      ]
    },
    {
      crime: "حدث انقطاع تام للكهرباء في المدينة بسبب تخريب متعمد.",
      suspect_roles: [
        "كهربائي 💡",
        "مهندس كهرباء 👷‍♂️",
        "عامل صيانة 🔧",
      ...
      clues: [
        "تم قطع الأسلاك بدقة واحترافية عالية.",
        "آخر شخص شوهد قرب المحطة كان يرتدي قفازات عازلة.",
        "الفاعل تجنب عن قصد قطع السلك الخاص بالمستشفى."
      ]
    },
    {
      crime: "تم العثور على أثار دماء نادرة بجانب جثة القتيل.",
      suspect_roles: [
        "جزَّار 🔪",
        "طبيب جراح 👨‍⚕️",
        "ممرضة 💉",
      ...
      clues: [
        "طريقة القتل تشير لمعرفة دقيقة بتشريح الأجسام.",
        "السلاح المستخدم هو سكين جزارة حاد جداً.",
        "تم العثور على مريلة ملطخة بالدماء مخبأة بالجوار."
      ]
    },
    {
      crime: "تم تزوير مستندات قانونية هامة لإتمام صفقة مشبوهة.",
      suspect_roles: [
        "محامي ⚖️",
        "كاتب عدل ✍️",
        "سكرتير 📠",
      ...
      clues: [
        "التوقيع المزور يحتوي على خطأ إملائي لا يلاحظه إلا خبير.",
        "تم استخدام نوع حبر يتلاشى بعد 24 ساعة.",
        "الفاعل لديه نسخة من الختم الرسمي للشركة."
      ]
    },
    // Scenarios 6-10 (Financial & Tech)
    {
      crime: "اختفت عملات رقمية بملايين الدولارات من منصة تداول مشهورة.",
      suspect_roles: [
        "هاكر 💻",
        "محلل مالي 📈",
        "مدير المنصة 👨‍💼",
      ...
      clues: [
        "تم الاختراق عبر ثغرة في تطبيق المحفظة الباردة.",
        "تم تحويل الأموال إلى عنوان جديد غير معروف.",
        "أحد الموظفين قام ببيع كل أسهمه قبل الحادث بيوم."
      ]
    },
    {
      crime: "تمت سرقة سيارة إسعاف واستخدامها في عملية سطو مسلح.",
      suspect_roles: [
        "مسعف 🚑",
        "طبيب طوارئ 👨‍⚕️",
        "ممرضة 💉",
      ...
      clues: [
        "السارق كان يعرف مكان مفاتيح سيارة الإسعاف.",
        "تم تعطيل جهاز التتبع GPS باحترافية.",
        "شوهد شخص يرتدي زي المسعفين وهو يضع قناعاً."
      ]
    },
    {
      crime: "تم تسريب أسئلة امتحان الثانوية العامة قبل موعده بساعات.",
      suspect_roles: [
        "مدرس 👨‍🏫",
        "طالب 📚",
        "مدير مدرسة 🏫",
        "عامل مطبعة 🖨️",
        "موظف وزارة التعليم 🏛️",
        "ولي أمر 👨‍👩‍👧",
        "هاكر 💻",
        "صاحب مركز دروس 🏢",
        "موجه المادة 🧐",
      ...
      clues: [
        "التسريب تم عبر تطبيق واتساب من رقم مجهول.",
        "الورق المستخدم هو نفس نوع ورق غرفة المدير.",
        "تم العثور على مبلغ مالي كبير في حساب أحد المشتبه بهم."
      ]
    },
    {
      crime: "تم العثور على مجوهرات أثرية مزيفة في متحف بدلاً من الأصلية.",
      suspect_roles: [
        "خبير مجوهرات 💍",
        "صائغ 💎",
        "حارس متحف 🏛️",
      ...
      clues: [
        "المجوهرات المزيفة متقنة الصنع.",
        "نظام الإنذار لم ينطلق، مما يعني أن الفاعل يعرف كلمة المرور.",
        "تم العثور على بقايا مادة لصناعة القوالب في غرفة أحد الحراس."
      ]
    },
    {
      crime:
        "تم تخريب خادم رئيسي لشركة ألعاب شهيرة، مما أدى إلى مسح بيانات اللاعبين.",
      suspect_roles: [
        "مبرمج ألعاب 🎮",
        "مدير مجتمع اللاعبين 👨‍👩‍👧‍👦",
        "لاعب محترف 🏆",
        ...
        "موظف سابق بالشركة",
        "مهندس شبكات 🌐",
        "مسؤول قاعدة البيانات 🗄️",
        "فني دعم 🎧",
        "مصمم شخصيات 👾",
        "مسؤول تسويق 📢"
      ],
      clues: [
        "التخريب تم باستخدام صلاحيات مدير النظام (Admin).",
        "تم ترك رسالة مشفرة تسخر من أمن الشركة.",
        "آخر عملية دخول للخادم كانت من جهاز داخل الشركة."
      ]
    }
  ];
  ...
  window.selectRounds = (num) => {
    totalRounds = num;
    document
      .querySelectorAll("#rounds-selection .btn-round")
      .forEach((button) => {
  ...
  window.selectTime = (minutes) => {
    ...
    document
      .querySelectorAll("#time-selection .btn-round")
      .forEach((button) => {
        button.classList.toggle(
          "selected",
          parseInt(button.textContent) === minutes
        );
      });
  ...
  window.showJudgeScreen = () => {
    ...
    document.getElementById(
      "judge-title"
    ).textContent = `أيها القاضي ${players[currentJudgeIndex].name}، أصدر حكمك!`;
    renderJudgeOptions();
    showScreen("judge");
  };
  ...
  function updatePlayerListUI() {
    ...
    players.forEach((player, index) => {
      ...
      playerDiv.className =
        "player-list-item flex justify-between items-center";
  ...
  function startNewRound() {
    ...
    currentJudgeIndex = playerIndices.splice(
      Math.floor(Math.random() * playerIndices.length),
      1
    )[0];
    criminalIndex = playerIndices.splice(
      Math.floor(Math.random() * playerIndices.length),
      1
    )[0];

    let suspectRoles = [...currentScenario.suspect_roles];
    const criminalRole = suspectRoles.splice(
      Math.floor(Math.random() * suspectRoles.length),
      1
    )[0];
    ...
    document.getElementById(
      "round-title-crime"
    ).textContent = `الجولة ${roundNumber} من ${totalRounds}`;
    document.getElementById(
      "judge-announcement"
    ).innerHTML = `<span class="font-bold text-yellow-400">${players[currentJudgeIndex].name}</span>, أنت القاضي!`;
  ...
  function setupRoleReveal() {
    const roleRevealContainer = document.getElementById(
      "role-reveal-container"
    );
    const roleDisplayContainer = document.getElementById(
    ...
    if (roleRevealIndex >= players.length) {
      ...
      document.getElementById("currentPlayerName").textContent =
        players[roleRevealIndex].name;
    }
  }

  function setupInvestigationScreen() {
    revealedCluesCount = 0;
    document.getElementById("crime-story-investigation").textContent =
      currentScenario.crime;
    updateTimerDisplay(investigationTime * 60);
  ...
  function renderScoreBoard() {
    ...
    board.innerHTML =
      '<h3 class="text-lg font-bold text-center mb-2">لوحة النقاط</h3>';
  ...
  function showGameOver() {
    ...
    sortedPlayers.forEach((p, index) => {
      ...
      scoreDiv.className =
        "text-xl p-2 bg-gray-200 rounded-lg flex justify-between border-2 border-black";
